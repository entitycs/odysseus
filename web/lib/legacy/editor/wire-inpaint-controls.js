...
export function wireInpaintControls({
  ...
  document
    .getElementById('ge-feather-slider')
  ...
  document
    .getElementById('ge-edgestroke-slider')
    ?.addEventListener('input', (e) => {
      const v = parseInt(e.target.value, 10);
  ...
  document
    .getElementById('ge-strength-slider')
    ?.addEventListener('input', (e) => {
      document.getElementById('ge-strength-label').textContent = (
        e.target.value / 100
      ).toFixed(2);
